...
namespace GameApi.Controllers
{
    ...
    public class CharacterController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<List<Character>>> Create(CreateCharacterDetails request)
        {
        ...
        [HttpPost("skill")]
        public async Task<ActionResult<Character>> AddCharacterSkill(AddCaracterSkillDto request)
        {
